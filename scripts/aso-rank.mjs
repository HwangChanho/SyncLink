 ...
 */
const TERM_GROUPS = {
  // 1.4.17~1.5.0 의 ASC 키워드 필드 27개(2026-09-24 appstore-listing-text 로 되읽음).
  keywords: [
    '자연어', '연인', '부부', '친구', '약속', '모임', '기념일', '생일', '데이트',
    '여행', '회의', '동아리', '음성', 'AI', '스케줄', '플래너', '리마인더', '알림',
    '체크리스트', '투두리스트', '다이어리', '100일', '마감', '운동', '러닝', '루틴', '습관',
  ],
  // 1.5.0 에서 이름이 「우리하루」로 바뀌었다. 옛 이름 「투투리스트」는 색인에서 빠지는지 보는 대조군으로 남긴다.
  brand: [
    '우리하루', '투투리스트', '투두리스트', '할 일', '공유 캘린더', '일정 관리', '캘린더', '일정',
  ],
  longtail: [
