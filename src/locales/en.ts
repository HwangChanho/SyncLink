const en = {
  ...
  auth: {
    guest: {
      ...
      demo_todo_groceries: 'Groceries',
      demo_todo_report: 'Finish the report',
      demo_todo_call: 'Call Mom',
  ...
  event: {
    ...
    create: {
      sheet_heading: 'What would you like to add?',
      type_event_title: 'Event',
      type_event_desc: 'Meetings and plans with a set time',
      type_workout_title: 'Workout',
      type_workout_desc: 'Gym muscle groups, running distance and pace',
      type_dday_title: 'D-Day',
      type_dday_desc: 'Days left until a target date, with a reminder',
      type_relative_title: 'Relative date',
      type_relative_desc: 'N days after a base date',
      save_failed_title: 'Could not save',
      save_failed_body: 'Please try again.',
      title_required_title: 'Please enter a title',
      workout_header: 'Workout',
      workout_kind_gym: 'Gym',
      workout_kind_running: 'Running',
      workout_time: 'Time',
      workout_parts: 'Muscle groups',
      workout_record: 'Details (optional)',
      workout_distance: 'Distance',
      workout_pace: 'Avg. pace',
      workout_minutes: 'min',
      workout_sec_per_km: 'sec / km',
      workout_auto_title_running: 'Running {{distance}}km',
      workout_saved: 'Workout saved',
      dday_header: 'D-Day',
      dday_placeholder: 'What are you counting down to?',
      dday_target_date: 'Target date',
      dday_reminder: 'Reminder',
      dday_reminder_hint: "We'll send a push notification at the time you pick.",
      dday_remind_1: '1 day before',
      dday_remind_3: '3 days before',
      dday_remind_7: '1 week before',
      dday_title_required_body: 'A D-Day needs a name before it can be saved.',
      dday_saved: 'D-Day added',
      dday_reminder_failed: 'Saved, but the reminder could not be set',
      relative_header: 'Relative date',
      relative_placeholder: 'What is it? (e.g. package arrives)',
      relative_base_hint: 'The day you start counting from, like an order or issue date.',
      relative_offset_label: 'How many days later?',
      relative_days_after: 'days later',
      relative_label_optional: 'Label (optional)',
      relative_title_required_body: 'Tell us what it is before saving.',
      relative_saved: 'Relative-date event added',
    },
  },
  ...
  space: {
    ...
    poll: {
      section: 'Polls',
      empty: 'No polls yet',
      empty_hint: 'Pick a date together or ask the group.',
      open: 'Open',
      closed: 'Closed',
      multi: 'Multiple choice',
      anonymous: 'Anonymous',
      anonymous_note: 'Choices are hidden in the app, but this is not a secret ballot.',
      voter_count: '{{count}} voted',
      voted_by: '{{count}}',
      close_action: 'Close',
      decide_action: 'Pick this',
      decide_title: 'Confirm this option?',
      decide_desc: 'This closes the poll with this result.',
      decide_desc_event: 'This closes the poll and creates a shared Space event at this time.',
      decide_confirm: 'Confirm',
      delete_title: 'Delete this poll?',
      delete_desc: 'All options and votes will be removed.',
      create_title: 'New poll',
      title_placeholder: 'What are you deciding? (e.g. weekend meetup)',
      ...
      need_options: 'Please add at least 2 options.',
    },
    ...
    share_message: 'You are invited to 우리하루 Space "{{name}}"!\nInvite code: {{code}}\nJoin link: {{link}}',
    email_body: 'You are invited to 우리하루 Space "{{name}}"!\n\nInvite code: {{code}}\nJoin link: {{link}}\n\nClick the link above or enter the code in the 우리하루 app to join.',
  ...
  contact: {
    ...
    denied: 'Contact access is blocked.\nGo to Settings → 우리하루 → Contacts → Allow to search and invite friends.',
  ...
  paywall: {
    ...
    features: [
      ...
      'Unlimited AI insights (time-of-day · pattern analysis)',
    ...
    purchase_complete_desc: 'Enjoy 우리하루 Pro!',
  ...
  analytics: {
    error_load: 'Could not load analytics data.',
    error_insight: 'Could not get insights.',
    preset_week: 'Weekly',
    preset_month: 'Monthly',
    ...
    stat_avg_day: 'Daily average',
    stat_busiest: 'Busiest day',
    stat_quietest: 'Quietest day',
    stat_top_category: 'Top category',
    stat_own: 'My events',
    stat_shared: 'Shared with me',
    stat_shared_pct: 'Shared ratio',
    count_unit: '',
    dow_suffix: '',
    hours: 'h',
    minutes: 'm',
    ...
    feature_distribution: 'Category · day · time-of-day distribution',
    feature_trend: 'Trends over time and your busiest hours',
    feature_ai: 'AI-tailored insights & next-week suggestions',
    summary_title: 'Summary',
    compare: 'vs previous {{period}}',
    retry: 'Try again',
    cat_share_title: 'Category share',
    empty_period: 'No events in this period',
    dow_dist_title: 'By day of week',
    heatmap_title: 'Day × time-of-day heatmap',
    tod_legend: 'Morning 5–12 · Noon 12–17 · Evening 17–22 · Night 22–5',
    own_share_title: 'My events · Shared events',
    weekly_trend_title: 'Weekly trend (last 8 weeks)',
    insights_desc: 'AI analyzes your schedule patterns to give natural-language insights and action suggestions.',
    paywall_title: 'Analytics is a Pro feature',
    paywall_desc: 'See your schedule patterns at a glance and plan smarter with AI insights.',
    pro_upgrade: 'Upgrade to Pro',
    gate_unlock: 'Tap to unlock with Pro',
    insight_loading: 'Analyzing…',
    insight_quota: "You've used all your free insights today. Go Pro for unlimited use.",
  },
} as const;
