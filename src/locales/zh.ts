const zh = {
  ...
  event: {
    ...
    create: {
      sheet_heading: '要添加什么？',
      type_event_title: '日程',
      type_event_desc: '约会、会议等有确定时间的安排',
      type_workout_title: '运动记录',
      type_workout_desc: '健身部位、跑步距离与配速',
      type_dday_title: 'D-Day',
      type_dday_desc: '距目标日期的天数 + 提醒',
      type_relative_title: '相对日程',
      type_relative_desc: '基准日之后的第 N 天',
      save_failed_title: '保存失败',
      save_failed_body: '请再试一次。',
      title_required_title: '请输入标题',
      workout_header: '运动记录',
      workout_kind_gym: '健身',
      workout_kind_running: '跑步',
      workout_time: '时间',
      workout_parts: '部位',
      workout_record: '记录（可选）',
      workout_distance: '距离',
      workout_pace: '平均配速',
      workout_minutes: '分',
      workout_sec_per_km: '秒 / 公里',
      workout_auto_title_running: '跑步 {{distance}}km',
      workout_saved: '已保存运动记录',
      dday_header: 'D-Day',
      dday_placeholder: '你在等待什么？',
      dday_target_date: '目标日期',
      dday_reminder: '提醒',
      dday_reminder_hint: '我们会在你选择的时间发送推送通知。',
      dday_remind_1: '提前一天',
      dday_remind_3: '提前三天',
      dday_remind_7: '提前一周',
      dday_title_required_body: '需要填写 D-Day 名称才能保存。',
      dday_saved: '已添加 D-Day',
      dday_reminder_failed: '日程已保存，但提醒设置失败',
      relative_header: '相对日程',
      relative_placeholder: '是什么安排？（例如：包裹送达）',
      relative_base_hint: '就像下单日、签发日那样开始计算的那一天。',
      relative_offset_label: '几天之后？',
      relative_days_after: '天后',
      relative_label_optional: '标签（可选）',
      relative_title_required_body: '填写这是什么安排后即可保存。',
      relative_saved: '已添加相对日程',
    },
  },
  ...
  space: {
    ...
    share_message: '邀请您加入 우리하루 Space "{{name}}"！\n邀请码：{{code}}\n加入链接：{{link}}',
    email_body: '邀请您加入 우리하루 Space "{{name}}"！\n\n邀请码：{{code}}\n加入链接：{{link}}\n\n点击上方链接，或在 우리하루 应用中输入邀请码加入。',
  ...
  paywall: {
    ...
    purchase_complete_desc: '开始使用 우리하루 Pro！',
