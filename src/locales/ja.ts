const ja = {
  ...
  auth: {
    guest: {
      ...
      demo_birthday: '母の誕生日 🎂',
      demo_movie: '映画鑑賞',
      demo_todo_groceries: '買い物',
      demo_todo_report: 'レポート仕上げ',
      demo_todo_call: '母に電話する',
  ...
  event: {
    ...
    create: {
      sheet_heading: '何を登録しますか？',
      type_event_title: '予定',
      type_event_desc: '約束・会議など時間が決まっている予定',
      type_workout_title: '運動記録',
      type_workout_desc: 'ジムの部位、ランニングの距離・ペース',
      type_dday_title: 'D-Day',
      type_dday_desc: '目標日までの残り日数＋通知',
      type_relative_title: '相対日の予定',
      type_relative_desc: '基準日からN日後',
      save_failed_title: '保存に失敗しました',
      save_failed_body: 'もう一度お試しください。',
      title_required_title: 'タイトルを入力してください',
      workout_header: '運動記録',
      workout_kind_gym: 'ジム',
      workout_kind_running: 'ランニング',
      workout_time: '時刻',
      workout_parts: '部位',
      workout_record: '記録（任意）',
      workout_distance: '距離',
      workout_pace: '平均ペース',
      workout_minutes: '分',
      workout_sec_per_km: '秒 / km',
      workout_auto_title_running: 'ランニング {{distance}}km',
      workout_saved: '運動記録を保存しました',
      dday_header: 'D-Day',
      dday_placeholder: '何を待っていますか？',
      dday_target_date: '目標日',
      dday_reminder: '通知',
      dday_reminder_hint: '選んだタイミングでプッシュ通知をお送りします。',
      dday_remind_1: '1日前',
      dday_remind_3: '3日前',
      dday_remind_7: '1週間前',
      dday_title_required_body: 'D-Dayの名前がないと保存できません。',
      dday_saved: 'D-Dayを登録しました',
      dday_reminder_failed: '予定は保存しましたが、通知の設定に失敗しました',
      relative_header: '相対日の予定',
      relative_placeholder: 'どんな予定ですか？（例：荷物の到着）',
      relative_base_hint: '発注日・発行日のように数え始める日です。',
      relative_offset_label: '何日後ですか？',
      relative_days_after: '日後',
      relative_label_optional: 'ラベル（任意）',
      relative_title_required_body: 'どんな予定か入力すると保存できます。',
      relative_saved: '相対日の予定を登録しました',
    },
  },
  ...
  space: {
    ...
    share_message: '우리하루 Space "{{name}}" に招待します！\n招待コード：{{code}}\n参加リンク：{{link}}',
    email_body: '우리하루 Space "{{name}}" に招待します！\n\n招待コード：{{code}}\n参加リンク：{{link}}\n\n上のリンクをクリックするか、우리하루 アプリでコードを入力して参加してください。',
  ...
  contact: {
    ...
    denied: '連絡先へのアクセスがブロックされています。\n設定 → 우리하루 → 連絡先 → 許可 に変更すると友達を検索して招待できます。',
  ...
  paywall: {
    ...
    purchase_complete_desc: '우리하루 Pro をお楽しみください！',
