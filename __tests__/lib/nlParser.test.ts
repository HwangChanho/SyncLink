 ...
 *
 * 이번 주 요일 규칙 (Build-63 갱신):
 *  - calendar week (Mon-Sun) 안의 정확한 그 요일을 그대로 반환.
 *  - 과거 요일이라도 다음 주로 점프하지 않음 — "이번 주" 와 "다음 주"
 *    의 의미를 명확히 구분 (LEAD 보고: "다음주랑 이번주 구분 못 한다").
 *  예) 이번 주 월요일 → 2026-04-20 (오늘 자체 = 월)
 *      이번 주 화요일 → 2026-04-21
 *      다음 주 월요일 → 2026-04-27
 *
 * @task TASK-310
...
describe('날짜 파싱', () => {
  ...
  test.each([
    ...
    ['이번 주 월요일',          '2026-04-20'], // Build-63: 오늘=월 그대로
    // ── 다음 주 ──
    ['다음 주 월요일',          '2026-04-27'],
    ['다음 주 화요일',          '2026-04-28'],
    ['다음 주 금요일',          '2026-05-01'],
