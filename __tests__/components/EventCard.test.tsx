...
// Mock useColors to prevent Zustand store subscription from blocking test teardown.
// The store calls Appearance.addChangeListener which keeps the process alive → SIGABRT.
jest.mock('@/hooks/useColors', () => ({
  useColors: () => ({
    primary:         'hsl(258, 65%, 48%)',
    primaryLight:    'hsl(258, 50%, 94%)',
    primaryDark:     'hsl(258, 70%, 38%)',
    accent:          'hsl(258, 72%, 52%)',
    background:      '#FFFFFF',
    ...
    warning:         '#D97706',
    error:           '#DC2626',
    tabActive:       'hsl(258, 65%, 48%)',
    tabInactive:     '#999999',
    inputBackground: '#F5F5F5',
    inputBorder:     '#E0E0E0',
    inputFocus:      'hsl(258, 65%, 48%)',
  }),
}));
